CREATE TABLE paises (paises_id SERIAL PRIMARY KEY,continente TEXT NOT NULL,nombre TEXT NOT NULL,fecha_creacion TIMESTAMPTZ NOT NULL DEFAULT NOW());CREATE TABLE persona (persona_id SERIAL PRIMARY KEY,cedula TEXT UNIQUE NOT NULL,nombre TEXT NOT NULL,fecha_nacimiento DATE NOT NULL,genero TEXT NOT NULL,fecha_creacion TIMESTAMPTZ NOT NULL DEFAULT NOW());CREATE TABLE empleado (
